...

{
    ...
    //     [HttpGet("servers")]
    //     public IActionResult GetServersWithApplications()
    //    {
    //         var serversWithApplications = _applicationService.GetServerLists().
    //         Include(s => s.GetApplicationLists()).ToList();
    //         return Ok(serversWithApplications);
    //    }
