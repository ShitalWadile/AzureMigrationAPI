...
namespace ctrlspec.Repository
{
    public class AdminRepository :IAdmin
    {
      /*   private readonly CtrlSpecDbContext _login;
        ...
        //  public IEnumerable<ApplicationList> ApplicationList()
        // {
        //     // Implement the logic to retrieve application data from the database
        //     return _context.ApplicationList.ToList();
        // }

        // public IEnumerable<ServerList> ServerList()
        // {
        //     // Implement the logic to retrieve server data from the database
        //     return _context.ServerList.ToList();
        // }
    }
}